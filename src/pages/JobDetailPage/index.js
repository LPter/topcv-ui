            ...
            <div className={cx('header')}>
                <div className={cx('header-container')}>
                    ...
                    <div className={cx('header-container__apply')}>
                        <button className={cx('header-container__apply-button')}>
                            <FontAwesomeIcon
                                icon={faPaperPlane}
                    ...
                    <div className={cx('recruit-container')}>
                        ...
                        <div className={cx('recruit-container__generalInfo')}>
                            <div className={cx('recruit-container__generalInfo-wrapper')}>
                                <p className={cx('recruit-container__generalInfo-wrapper__title')}>Thông tin chung</p>
                            ...
                            <div className={cx('company-container__info-item')}>
                                ...
                                <div>
                                    ...
                                    <span>
                                        ...
                                        <p>
                                            Công ty TNHH Đầu tư phát triển quốc tế Sơn Hà: được thành lập đầu tiên trong
                                            khối SHC từ năm 2013 đến nay trải qua gần 10 năm xây dựng và phát triển hiện
                                            tại Sơn Hà đang là công ty hàng đầu trong việc cung cấp các mặt hàng khoáng
                                            sản trong nước. Phục vụ các ngành xây dựng, thực ăn chăn nuôi, thủy sản,
                                            vv.....
                                        </p>
                                        <p>
                                            Công ty TNHH Khoáng Sản Sơn Hà 18: Với sự phát triển vượt bậc về tiêu thụ
                                            sản lượng của Công ty Sơn Hà. SHC Group đầu tư kinh phí lớn xây dựng Nhà máy
                                            với dây chuyền khép kín, máy móc hiện đại bậc nhất tại chuyên cung cấp các
                                            mặt hàng khoáng sản phục vụ cho trong nước và xuất khẩu. Nhà máy đặt tại Kim
                                            Bảng, Hà Nam
                                        </p>
                                        <p>
                                            Công ty TNHH Khoáng Sản Công Nghệ Việt Nam: Công ty được thành lập sau cùng,
                                            thành lập năm 2019 chuyên về kinh doanh mặt hàng xuất khẩu đi các nước Mỹ,
                                            Ấn Độ, Nhật vv.... Mặc dù thành lập sau cũng tuy nhiên hiện tại Công ty
                                            Khoáng Sản Công Nghệ đang có doanh thu vượt bậc và đáng kinh ngạc nhất. Hiện
                                            tại công ty đã Cổ phần thành công và đổi tên thành Công ty Cổ Phần Khoáng
                                            Sản Công Nghệ Việt Nam
                                        </p>
                                        <p>&nbsp;</p>
                                    </span>
                                </div>
